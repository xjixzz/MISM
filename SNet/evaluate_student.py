...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        encoder_path = os.path.join(opt.load_weights_folder, "s_encoder.pth")
        decoder_path = os.path.join(opt.load_weights_folder, "s_depth.pth")
    ...
    print("   Student SNet evaluation - using median scaling")
